 ...
 */
final class Version20250320130836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_CD1DE18AA76ED395 ON department (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_CD1DE18AA76ED395 ON department');
